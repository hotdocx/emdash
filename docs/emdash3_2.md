...
| `FORMAL-ELABORATION-BOUNDARY` | research-boundary | The canonical mathematical surface has no current production parser and end-to-end compiler to the active Lambdapi owners; the parent TypeScript prototype is read-only feasibility evidence and is absent from the book build graph. | — | — |

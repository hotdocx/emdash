...
describe('PATHOUT-LIBRARY-FOUNDATION-1B0 delegated v9 review', () => {
    it('approves only checkpointed v9 with human supersession', () => {
    ...
    it('authorizes exact root-only 5/13/2/9 over corrected predecessor',
        () => {
        const authorization =

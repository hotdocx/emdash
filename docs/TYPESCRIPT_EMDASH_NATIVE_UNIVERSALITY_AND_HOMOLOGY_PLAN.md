...
Status: active — original left homology endpoint comparison qualified; right endpoint/sign next; six-term observation gap and displayed CAS transport still required
...
| NUH-6 | active: original left H comparison qualified; right endpoint/sign next; 6C3b gap retained | Complete LES/reference/sign work and the retained comparison/witness qualification before NUH-7 |

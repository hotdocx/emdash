import { 
    addConstraint, getDebugVerbose, printTerm, FH
}
from './src/core_state';
import {
...
import {
    ...
    emptyCtx, getTermRef, userRewriteRules, // Removed StoredRewriteRule from here
    cloneTerm, setDebugVerbose, // Imported FH, removed freshHoleName
    globalDefs,
    setupCatTheoryPrimitives
} from './src/core_context_globals';
import {
    areEqual, normalize, whnf, unify, solveConstraints // Removed UnifyResult from here
} from './src/core_logic';
import {
    elaborate, infer, check, isPatternVarName, matchPattern, ElaborationOptions

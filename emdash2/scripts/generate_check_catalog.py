...
AREAS: list[Area] = [
    ...
    Area(
        ...
        (
            "omega_equiv_along_D0_to_EQ1",
            "omega_equiv_D0_to_EQ1",
            "omega_equiv_along_EQ1_to_D0",
            "omega_equiv_EQ1_to_D0",
        ),
    ),
    Area(
        ...
        (
            ...
            "omega_grpd_",
            "omega_along_to_type_equiv_EQ1",
            "omega_to_type_equiv_EQ1",
            "@GrpdPathView A B",
        ),
    ),
    Area(
        ...
        (
            "OmegaEquivAlongEqData_EQ1",
            "OmegaEquivAlong_EQ1",
            "omega_equiv_along_intro_EQ1",
            "omega_equiv_along_left_inv_EQ1",
            "omega_equiv_along_right_inv_EQ1",
            "omega_equiv_along_left_law_EQ1",
            "omega_equiv_along_right_law_EQ1",
            "omega_equiv_along_ind_EQ1",
            "omega_equiv_along_refl_EQ1",
            "OmegaEquiv_EQ1",
            "omega_equiv_pack_EQ1",
            "omega_equiv_to_EQ1",
            "omega_equiv_evidence_EQ1",
            "omega_equiv_ind_EQ1",
            "omega_equiv_refl_EQ1",
            "omega_equiv_eta_EQ1",
            "OmegaEquivSigma_EQ1",
            "omega_facade_to_sigma_EQ1",
            "omega_sigma_to_facade_EQ1",
            "omega_sigma_roundtrip_EQ1",
            "omega_facade_roundtrip_EQ1",
            "object_path_equiv_",
            "path_equiv_",
            "IsGroupoidalCat_EQ1",
            "path_cat_is_groupoidal_EQ1",
        ),
    ),
    Area(

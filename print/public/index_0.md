...
- Lambdapi typecheck: `EMDASH_TYPECHECK_TIMEOUT=60s make check`
- Paper JSON validation: `npm run validate:paper -w print`
- Build + headless render check: `npm run check:render -w print`

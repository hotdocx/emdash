...
| `AGENT-EVAL-12B3` | Exact npm release and additive CloserFans benchmark workspace | proposal/review/candidate `bb16e47`/`0027c66`/`995e497`; external/host stages pending | Exact `0.3.0`, current action pins, non-persisted checkout credentials, two identical local packs, and focused release/package/consumer gates are green. Clean external audit precedes every push, integration, tag, Release, or deployment effect. |

...
export function createFormalFreydNativeModelObservationProofEnvironment(inputs: readonly AffineFormalZariskiInputDeclaration[]) {
    ...
    // These two raw-data constructors are independent of any model. Reuse
    ...
    add('bridge_freyd_adjunction_model_map', [['R', ring, 'implicit'], ['M', model],
    ...
    s => L.tau(L.call('bridge_CommRingFreydHomSet', [s.R, H(s, true), H(s, false)])));

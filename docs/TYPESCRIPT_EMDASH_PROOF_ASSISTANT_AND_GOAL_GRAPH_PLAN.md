...
| `AGENT-EVAL-12B4` | Reproducible real-agent runs and measured graduation | R10 one-file fix qualified; access review pending | CloserFans `d1a270e` removes only unsupported `O_CLOEXEC`, retains mandatory `O_NOFOLLOW`, and passes syntax, unchanged synthetic, runtime-constant, static capability, diff, hash, and clean-tree gates. |

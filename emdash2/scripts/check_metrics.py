...
CORE_CHECK_FILES = [
    ...
    Path("emdash3_2_one_cat_adjunction_zero_column_observations.lp"),
    ...
    Path("emdash3_2_product_family_views.lp"),
    Path("emdash3_2_one_cat_product_adjunction.lp"),
    Path("emdash3_2_one_cat_product_families.lp"),
    Path("emdash3_2_one_cat_adjunction_family_views.lp"),
    Path("emdash3_2_one_cat_adjunction_evaluation_paths.lp"),
    Path("emdash3_2_zero_arrow_family_action_paths.lp"),
    Path("emdash3_2_one_cat_terminal_family_paths.lp"),
    Path("emdash3_2_one_cat_diagram_family_reflection.lp"),
    Path("emdash3_2_one_cat_arrow_family_isomorphisms.lp"),
    Path("emdash3_2_one_cat_diagram_family_reconstruction.lp"),
    Path("emdash3_2_one_cat_terminal_adjunction_families.lp"),
    Path("emdash3_2_one_cat_terminal_adjunction_family_observations.lp"),
    ...
    Path("emdash3_2_one_cat_kernel_family_inputs.lp"),
    Path("emdash3_2_one_cat_kernel_family_lift.lp"),
    Path("emdash3_2_one_cat_kernel_precomposition.lp"),
    Path("emdash3_2_hom_action_factorization_views.lp"),
    Path("emdash3_2_one_cat_whiskering_paths.lp"),
    Path("emdash3_2_one_cat_kernel_family_projection_paths.lp"),
    Path("emdash3_2_one_cat_kernel_family_reconstruction.lp"),
    Path("emdash3_2_groupoidal_object_maps.lp"),
    Path("emdash3_2_discrete_functor_paths.lp"),
    Path("emdash3_2_terminal_category_profile.lp"),
    Path("emdash3_2_one_cat_slice_paths.lp"),
    Path("emdash3_2_slice_sigma_arrow_paths.lp"),
    Path("emdash3_2_one_cat_functor_postcomposition_paths.lp"),
    Path("emdash3_2_one_cat_kernel_pullback_comparison.lp"),
    Path("emdash3_2_one_cat_kernel_pullback_lifts.lp"),
    Path("emdash3_2_one_cat_kernel_pullback_universality.lp"),
    Path("emdash3_2_one_cat_cokernel_family_projection_paths.lp"),
    Path("emdash3_2_one_cat_cokernel_family_reconstruction.lp"),
    Path("emdash3_2_omega_equiv_cancellation_paths.lp"),
    Path("emdash3_2_one_cat_short_exact_family_cancellation.lp"),
    Path("emdash3_2_one_cat_homology_cover_maps.lp"),
    Path("emdash3_2_diagram_reindex_views.lp"),
    Path("emdash3_2_one_cat_family_naturality_paths.lp"),
    Path("emdash3_2_one_cat_zero_cone_row_families.lp"),
    Path("emdash3_2_one_cat_kernel_input_observation_paths.lp"),
    Path("emdash3_2_one_cat_kernel_family_point_paths.lp"),
    Path("emdash3_2_one_cat_cokernel_family_point_paths.lp"),
    Path("emdash3_2_one_cat_zero_family_postcomposition_paths.lp"),
    Path("emdash3_2_one_cat_zero_cone_column_inputs.lp"),
    Path("emdash3_2_one_cat_short_exact_family_lifts.lp"),
    Path("emdash3_2_one_cat_homology_covered_maps.lp"),
    Path("emdash3_2_one_cat_native_homology_window_maps.lp"),
    Path("emdash3_2_one_cat_biproduct_injections.lp"),
    Path("emdash3_2_one_cat_biproduct_adjunction.lp"),
    Path("emdash3_2_one_cat_copair_families.lp"),
    Path("emdash3_2_whiskering_component_paths.lp"),
    Path("emdash3_2_one_cat_copair_family_paths.lp"),
    Path("emdash3_2_one_cat_additive_families.lp"),
    Path("emdash3_2_one_cat_additive_family_paths.lp"),
    Path("emdash3_2_additive_shears.lp"),
    Path("emdash3_2_one_cat_product_family_inverse_components.lp"),
    Path("emdash3_2_one_cat_shear_families.lp"),
    Path("emdash3_2_preadditive_zero_family_components.lp"),
    Path("emdash3_2_one_cat_negative_identity.lp"),
    Path("emdash3_2_one_cat_negative_families.lp"),
    Path("emdash3_2_one_cat_difference_families.lp"),
    Path("emdash3_2_product_composition_paths.lp"),
    Path("emdash3_2_product_family_action_views.lp"),
    Path("emdash3_2_one_cat_adjunction_transpose_paths.lp"),
    Path("emdash3_2_product_family_tuple_paths.lp"),
    Path("emdash3_2_one_cat_product_family_projection_paths.lp"),
    Path("emdash3_2_product_family_maps.lp"),
    Path("emdash3_2_one_cat_biproduct_family_distribution.lp"),
    Path("emdash3_2_one_cat_additive_family_bilinearity.lp"),
    Path("emdash3_2_one_cat_difference_family_bilinearity.lp"),
    Path("emdash3_2_reindex_composition_paths.lp"),
    Path("emdash3_2_one_cat_adjunction_family_reindex.lp"),
    Path("emdash3_2_product_family_reindex.lp"),
    Path("emdash3_2_one_cat_biproduct_family_reindex.lp"),
    Path("emdash3_2_one_cat_shear_additive_inverse_paths.lp"),
    Path("emdash3_2_one_cat_additive_family_inverse.lp"),
    Path("emdash3_2_one_cat_additive_family_cancellation.lp"),
    Path("emdash3_2_omega_equiv_composition.lp"),
    Path("emdash3_2_omega_equiv_right_factor.lp"),
    Path("emdash3_2_one_cat_natural_equivalence_transport.lp"),
    Path("emdash3_2_one_cat_zero_kernel_families.lp"),
    Path("emdash3_2_one_cat_coimage_factor_paths.lp"),
    Path("emdash3_2_one_cat_difference_cospans.lp"),
    Path("emdash3_2_one_cat_cokernel_family_annihilation.lp"),
    Path("emdash3_2_one_cat_zero_cokernel_covers.lp"),
    Path("emdash3_2_one_cat_difference_cokernels.lp"),
    Path("emdash3_2_one_cat_difference_covers.lp"),
    Path("emdash3_2_one_cat_coimage_cover_descent.lp"),
    Path("emdash3_2_one_cat_difference_cover_closure.lp"),
    Path("emdash3_2_one_cat_kernel_difference_lifts.lp"),
    Path("emdash3_2_one_cat_difference_factor_paths.lp"),
    Path("emdash3_2_one_cat_kernel_precomposition_covers.lp"),
    Path("emdash3_2_one_cat_homology_covers.lp"),
    Path("emdash3_2_one_cat_native_homology_window_covers.lp"),
    Path("emdash3_2_one_cat_kernel_input_boundaries.lp"),
    Path("emdash3_2_one_cat_native_connecting_kernel_paths.lp"),
    Path("emdash3_2_one_cat_native_cycles_connecting.lp"),
    Path("emdash3_2_one_cat_native_connecting_upper_lifts.lp"),
    Path("emdash3_2_one_cat_native_connecting.lp"),
    Path("emdash3_2_one_cat_native_homology_window_connecting.lp"),
    Path("emdash3_2_native_snake_inputs.lp"),
    Path("emdash3_2_one_cat_native_snake_factors.lp"),
    Path("emdash3_2_one_cat_native_snake_cover.lp"),
    Path("emdash3_2_one_cat_native_snake_covered_map.lp"),
    Path("emdash3_2_one_cat_image_family_covers.lp"),
    Path("emdash3_2_one_cat_native_snake_image.lp"),
    Path("emdash3_2_one_cat_native_snake_kernel_annihilation.lp"),
    Path("emdash3_2_one_cat_native_snake_connecting.lp"),
    Path("emdash3_2_one_cat_native_snake_six_term_maps.lp"),
    Path("emdash3_2_one_cat_native_snake_outer_zeros.lp"),
    Path("emdash3_2_one_cat_native_snake_middle_lifts.lp"),
    Path("emdash3_2_one_cat_native_snake_inner_zeros.lp"),
    Path("emdash3_2_one_cat_native_snake_exact_inputs.lp"),
    Path("emdash3_2_one_cat_native_snake_comparison_kernels.lp"),
    Path("emdash3_2_one_cat_native_snake_first_kernel_comparison.lp"),
    Path("emdash3_2_one_cat_native_snake_first_cover.lp"),
    Path("emdash3_2_one_cat_native_snake_first_exactness.lp"),
    Path("emdash3_2_one_cat_native_snake_second_covers.lp"),
    Path("emdash3_2_one_cat_native_snake_second_representatives.lp"),
    Path("emdash3_2_one_cat_native_snake_second_exactness.lp"),
    Path("emdash3_2_one_cat_native_snake_third_covers.lp"),
    Path("emdash3_2_one_cat_native_snake_third_representatives.lp"),
    Path("emdash3_2_one_cat_native_snake_third_exactness.lp"),
    ...
    Path("emdash3_2_one_cat_native_window_snake_cycles.lp"),
    Path("emdash3_2_one_cat_copair_annihilation_views.lp"),
    Path("emdash3_2_one_cat_native_window_snake_left_boundary.lp"),
    Path("emdash3_2_one_cat_native_window_snake_left_homology.lp"),
    Path("emdash3_2_one_cat_short_exact_family_colifts.lp"),
    Path("emdash3_2_one_cat_native_window_snake_right_quotients.lp"),
    Path("emdash3_2_one_cat_native_window_snake_right_gamma.lp"),
    Path("emdash3_2_one_cat_native_window_snake_right_kernel_quotients.lp"),
    Path("emdash3_2_one_cat_native_window_snake_right_kernel_pair.lp"),
    Path("emdash3_2_one_cat_native_window_snake_right_kernels.lp"),
    Path("emdash3_2_one_cat_native_homology_quotient_comparison.lp"),
    Path("emdash3_2_one_cat_native_homology_quotient_cover_source.lp"),
    Path("emdash3_2_one_cat_native_homology_quotient_covers.lp"),
    Path("emdash3_2_one_cat_native_homology_quotient_image.lp"),
    Path("emdash3_2_one_cat_native_homology_quotient_equivalence.lp"),
    ...
    Path("emdash3_2_one_cat_homology_family_maps.lp"),
    Path("emdash3_2_one_cat_middle_column_inputs.lp"),
    Path("emdash3_2_one_cat_row_homology_maps.lp"),
    Path("emdash3_2_one_cat_row_homology_zero_pairs.lp"),
    Path("emdash3_2_one_cat_covered_middle_cycles.lp"),
    Path("emdash3_2_one_cat_native_connecting_projection_zero.lp"),
    Path("emdash3_2_one_cat_native_connecting_inclusion_zero.lp"),
    Path("emdash3_2_one_cat_native_homology_window_exact_inputs.lp"),
    Path("emdash3_2_one_cat_zero_cokernel_families.lp"),
    Path("emdash3_2_one_cat_inverse_from_universal_zeros.lp"),
    Path("emdash3_2_one_cat_image_kernel_inclusion_paths.lp"),
    Path("emdash3_2_one_cat_image_kernel_exactness.lp"),
    Path("emdash3_2_one_cat_native_exact_comparison_kernels.lp"),
    Path("emdash3_2_one_cat_cospan_kernel_covers.lp"),
    Path("emdash3_2_one_cat_quotient_cokernel_zero.lp"),
    Path("emdash3_2_one_cat_homology_representatives.lp"),
    Path("emdash3_2_one_cat_boundary_representatives.lp"),
    Path("emdash3_2_one_cat_middle_homology_representatives.lp"),
    Path("emdash3_2_one_cat_middle_homology_cycles.lp"),
    Path("emdash3_2_one_cat_biproduct_injection_reindex.lp"),
    Path("emdash3_2_one_cat_copair_injection_paths.lp"),
    Path("emdash3_2_one_cat_additive_family_units.lp"),
    Path("emdash3_2_one_cat_middle_homology_exactness.lp"),
    Path("emdash3_2_one_cat_native_middle_homology_exactness.lp"),
    Path("emdash3_2_one_cat_connecting_source_representatives.lp"),
    Path("emdash3_2_one_cat_connecting_source_cycles.lp"),
    Path("emdash3_2_one_cat_connecting_source_exactness.lp"),
    Path("emdash3_2_one_cat_connecting_target_representatives.lp"),
    Path("emdash3_2_one_cat_connecting_target_lifts.lp"),
    Path("emdash3_2_one_cat_connecting_target_exactness.lp"),
    ...
    Path("emdash3_2_zero_arrow_family_observations.lp"),
    Path("emdash3_2_zero_arrow_pair_observations.lp"),
    Path("emdash3_2_one_cat_zero_family_paths.lp"),
    ...
    Path("emdash3_2_one_cat_categorical_exactness_points.lp"),
    Path("emdash3_2_one_cat_native_pair_comparisons.lp"),
    Path("emdash3_2_one_cat_pair_comparison_zero.lp"),
    Path("emdash3_2_one_cat_native_public_pair_exactness.lp"),
    Path("emdash3_2_one_cat_family_public_pair_exactness.lp"),
    Path("emdash3_2_one_cat_native_observed_exactness.lp"),
    Path("emdash3_2_one_cat_native_exact_diagrams.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_diagram_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_les_certificate_views.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_middle_pair_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_source_pair_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_target_pair_exactness.lp"),
    Path("emdash3_2_equivalence_conjugation_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_delta_comparison.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_middle_public_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_source_public_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_target_public_exactness.lp"),
    ...
    Path("emdash3_2_cokernel_adjunction_families.lp"),
    Path("emdash3_2_homology_families.lp"),
    Path("emdash3_2_homology_family_selected_views.lp"),
    Path("emdash3_2_zero_arrow_cones.lp"),
    Path("emdash3_2_zero_arrow_family_point_inputs.lp"),
    Path("emdash3_2_zero_arrow_family_point_comparisons.lp"),
    ...
    Path("emdash3_2_homology_adjunction_input_data.lp"),
    Path("emdash3_2_homology_adjunction_record_data.lp"),
    Path("emdash3_2_homology_family_point_comparisons.lp"),
    Path("emdash3_2_one_cat_diagram_map_equivalences.lp"),
    Path("emdash3_2_homology_family_point_diagrams.lp"),
    Path("emdash3_2_homology_family_point_paths.lp"),
    Path("emdash3_2_one_cat_quotient_comparison_paths.lp"),
    Path("emdash3_2_homology_family_map_point_observations.lp"),
    Path("emdash3_2_kernel_family_map_point_views.lp"),
    Path("emdash3_2_homology_native_comparison_cycle_paths.lp"),
    Path("emdash3_2_homology_native_map_comparison_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_row_point_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_column_diagram_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_column_homology_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_raw_column_chain_maps.lp"),
    Path("emdash3_2_commutative_algebra_freyd_column_homology_projection_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_middle_column_inputs.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_middle_column_comparisons.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_middle_column_quotient_paths.lp"),
    Path("emdash3_2_image_family_point_comparisons.lp"),
    Path("emdash3_2_coimage_family_point_comparisons.lp"),
    Path("emdash3_2_zero_arrow_family_point_diagrams.lp"),
    ...
    Path("emdash3_2_prop_fibre_constructor_paths.lp"),
    Path("emdash3_2_zero_arrow_cone_maps.lp"),
    Path("emdash3_2_one_cat_zero_cone_map_paths.lp"),
    Path("emdash3_2_omega_equiv_inverse_square.lp"),
    Path("emdash3_2_one_cat_zero_cone_map_equivalences.lp"),
    Path("emdash3_2_one_cat_diagram_map_paths.lp"),
    Path("emdash3_2_one_cat_cokernel_point_cancellation.lp"),
    ...
    Path("emdash3_2_one_cat_constant_chain_zeros.lp"),
    Path("emdash3_2_one_cat_constant_snake_inputs.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_row_paths.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_row_zeros.lp"),
    Path("emdash3_2_commutative_algebra_freyd_native_row_short_exact.lp"),
    ...
    Path("emdash3_2_commutative_algebra_freyd_raw_window_connecting.lp"),
    ...
    Path("emdash3_2_commutative_algebra_freyd_diagram_observations.lp"),
    ...
    Path("emdash3_2_commutative_algebra_freyd_native_exactness_observations.lp"),
    Path("emdash3_2_commutative_algebra_freyd_exactness_point_data.lp"),
    Path("emdash3_2_commutative_algebra_freyd_adjunction_model_exactness_observations.lp"),
    Path("emdash3_2_commutative_algebra_freyd_adjunction_model_point_exactness.lp"),
    Path("emdash3_2_commutative_algebra_freyd_window_pair_observations.lp"),
    ...
    Path("emdash3_2_commutative_algebra_freyd_adjunction_model_exactness.lp"),
    ...
    Path("emdash3_2_finite_family_paths.lp"),
    ...
    Path("emdash3_2_arrow_equivalence_observations.lp"),
...
SPECIAL_ORDINARY_EXACTNESS_CHECK_FILES = {
    Path("emdash3_2_exactness_covers_foundation.lp"),
    Path("emdash3_2_exactness_covers.lp"),
    Path("emdash3_2_exactness_covers_from_exact.lp"),
    Path("emdash3_2_abelian_canonical_kernel_exactness.lp"),
...
SPECIAL_ORDINARY_ROW_CHECK_FILES = {
    Path("emdash3_2_kernel_domain_comparison.lp"),
    Path("emdash3_2_cokernel_codomain_comparison.lp"),
    Path("emdash3_2_abelian_structure_elimination.lp"),
    Path("examples/abelian_structure_elimination.lp"),
}
SPECIAL_ORDINARY_CYCLE_CHECK_FILES = {
    Path("emdash3_2_chain_pair_map_cycle_lifts.lp"),
    Path("emdash3_2_hom_factor_source_isos.lp"),
    Path("emdash3_2_short_exact_row_chain_columns.lp"),
...
ISOLATED_CHECK_GROUPS = (
    ...
    (SPECIAL_ORDINARY_CYCLE_CHECK_FILES, "./scripts/check_ordinary_cycle_factors.sh"),
    (SPECIAL_ORDINARY_EXACTNESS_CHECK_FILES, "./scripts/check_ordinary_exactness_support.sh"),
    (SPECIAL_NORMALIZATION_CHECK_FILES, "./scripts/check_short_exact_normalization.sh"),
    (SPECIAL_ORDINARY_ROW_CHECK_FILES, "./scripts/check_ordinary_row_comparisons.sh"),
)

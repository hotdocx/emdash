...
`0.3.0` local candidate is proportionally qualified and awaits the immediate
candidate/ledger checkpoint pair before external integration; the first
...
| `AGENT-EVAL-12B3` | Exact npm release and additive CloserFans benchmark workspace | proposal/review `bb16e47`/`0027c66`; Stage A local candidate qualified; external/host stages pending | Exact `0.3.0`, current action pins, non-persisted checkout credentials, two identical local packs, and focused release/package/consumer gates are green. Candidate checkpoint and immediate ledger pin precede every external effect. |
...
> `bb16e47`/`0027c66` as the sole staged implementation authority. Qualify and
> release exact `0.3.0`

...
import { createFormalFreydNativeSnakeProofEnvironment } from './algebra_formal_freyd_native_snake_signatures';
...
export const ALGEBRA_FORMAL_FREYD_NATIVE_SNAKE_CONTEXT_PROFILE = Object.freeze({
    revision: 'emdash-formal-native-rational-snake-context-v1' as const,

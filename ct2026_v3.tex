...
are performed by normalization; what remains is chiefly elaboration and user-facing syntax.
...
$E\colon B\to \mathbf{Cat}$). Fix a base object $b_0\in B$ and a fibre object $e_0\in E(b_0)$.

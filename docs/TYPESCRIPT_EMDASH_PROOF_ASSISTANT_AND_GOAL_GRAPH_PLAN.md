...
| `AGENT-EVAL-12B3` | Exact npm release and additive CloserFans benchmark workspace | public `0.3.0` verified; permanent workflow hardening locally green; host stage pending | Pages and live benchmark passed. Reviewed OIDC recovery run `31510726533` published byte-identical, attested registry bytes after two preserved pre-package failures. Temporary dispatch removal must be checkpointed and verified on public `main` before CloserFans. |
...
`AGENT-EVAL-12B3`, `AGENT-EVAL-12B4`, and `GOAL-GRAPH-14B4`.
...
| `D-PA-196` | Verify exact public `@hotdocx/emdash@0.3.0` from recovery run `31510726533` and qualify mandatory permanent hardening. | Exact build/publish jobs `93843570505`/`93843776669`, protected environment `19605245682`, deployment `5854097178`, artifact `9108950678`, OIDC/SLSA/npm attestations, signature, Sigstore log `2423388773`, dist metadata, and fresh installed consumers are green. Local, artifact, and registry tarballs are byte-identical at 162 entries, 2,778,964 bytes, SHA-256 `49c4f2ca7a12f1bc0f7721044015c1df3bee17e849bc593b99a9161206178541`. Workflow provenance resolves `7e275a7`; build logs prove package source `995e497`. Temporary dispatch removal restores the exact reviewed R1 workflow/test blobs and passes 3/3 policy, lint, YAML, trigger-absence, and diff gates. Pin the hardening checkpoint next; CloserFans remains gated until public workflow bytes match. |

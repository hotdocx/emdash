...
the separately bounded transitivity slice `1E` now has a frozen behavior-free
**0/0/0/5** proposal and separate immutable review authorizing only its exact

...
| `AGENT-EVAL-12B3` | Exact npm release and additive CloserFans benchmark workspace | next proposal/audit selected; implementation gated | Requires qualified 12B2 checkpoint `93c9804`, a separate version/release contract, and fresh sibling edit-time audit. |
...
model run, or hosted action is automatically authorized.

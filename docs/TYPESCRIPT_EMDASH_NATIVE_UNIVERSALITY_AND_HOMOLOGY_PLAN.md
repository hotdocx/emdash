...
Status: active — original right kernel comparison qualified; right H identification/sign next; six-term observation gap and displayed CAS transport still required
...
| NUH-6 | active: original right kernel comparison qualified; right H identification/sign next; 6C3b gap retained | Complete LES/reference/sign work and the retained comparison/witness qualification before NUH-7 |

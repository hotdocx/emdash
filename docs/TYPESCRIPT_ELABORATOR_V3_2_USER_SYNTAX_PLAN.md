...
| SYNTAX-PARITY-1B0 / D002 | focused-green zero-delta audit at `be7000f`; exact review approved with human supersession | completed `SYNTAX-PARITY-1A` | Measured the textual `indexOf` seam and split contextual index, independent siblings, and dependent/mixed telescopes into 1B1/1B2/1B3 |
| SYNTAX-PARITY-1B1 | final-green at `9f663555a1edbedcb99e97f1271154ff36913f05` | approved D002 review | Exact unary `indexOf` route, displayed weakening equality, failures, seventh reviewer preset, and 39/39 proportional gate |
| SYNTAX-PARITY-1B2 / 1B3 | gated on separate later proposals | final-green predecessor | Independent sibling/`fibrePair`, then genuine dependent/mixed telescope presentation |

 ...
 * @file types.ts
 *
 * Defines the core data structures for terms, types, contexts,
 * rewrite rules, and other fundamental entities in the Emdash type system.
 * This includes the constructors for various term types.
 */
...
// --- Category Theory Term Constructors ---
...
// Raw rule definition for storage before elaboration
...
// Rule after elaboration, ready for matching
export interface StoredRewriteRule {
    name: string;
    patternVars: PatternVarDecl[];
    elaboratedLhs: Term;
    elaboratedRhs: Term;

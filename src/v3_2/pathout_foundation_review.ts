 ...
 *
 * Proposals v1-v7 and their reviews are retained as superseded evidence.
 * This review approves only checkpointed v8 under the user's standing
...
const rawReview = {
    revision: 'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEWED-7',
    status: 'reviewed-v8-approved-under-delegated-unattended-authority',
    approval: {
        ...
        condition:
            'no-immediate-human-objection-after-v8-proposal-checkpoint',
        ...
        approvedProposalCheckpoint: '6e4bb82'
    },
    recommendation:
    ...
    validation: {
        correctedProposalCheckpoint: '6e4bb82',
    ...
    nonEffects: [
        'does-not-mutate-the-checkpointed-v8-proposal',
...
export function validateCorePathoutFoundation1b0Review(
    ...
    if (
        review.revision !==
            'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEWED-7' ||
        ...
        review.approval.approvedProposalCheckpoint !== '6e4bb82'
    ) {
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_DECISION_DRIFT',
            'The exact corrected-v8 delegated decision drifted'
        );
    }
    ...
    if (
        ...
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_AUTHORIZATION_DRIFT',
            'The review exceeded the exact root-only 5/12/2/9 boundary'
        );
    }
}

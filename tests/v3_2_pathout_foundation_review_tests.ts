...
describe('PATHOUT-LIBRARY-FOUNDATION-1B0 v4 review supersession', () => {
    it('withdraws v4 after the measured weak-head fusion gap', () => {
    ...
    it('freezes root-only 4/9/1/9 without implementation authority',
        () => {
        const authorization =

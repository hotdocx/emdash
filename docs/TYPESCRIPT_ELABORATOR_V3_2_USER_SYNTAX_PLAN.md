...
| SYNTAX-PARITY-1B1 | final-green; exact local checkpoint staging in progress | approved D002 review | Exact unary `indexOf` route, displayed weakening equality, failures, seventh reviewer preset, and 39/39 proportional gate |

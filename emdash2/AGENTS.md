...
83. `emdash3_2_circle_connectedness.lp` for the rule-free first concrete
...
84. `emdash3_2_walking_circle_restriction.lp` for the transparent rule-free
...
85. `emdash3_2_walking_circle_extension.lp` for the whole inverse candidate
...
86. `emdash3_2_walking_circle_universality.lp` for the rule-free concrete
...
87. `emdash3_2_walking_circle_monodromy.lp` for the rule-free universe-valued
...
88. `emdash3_2_groupoidal_interval_hit.lp` for the opaque two-endpoint
...
89. `emdash3_2_walking_interval_comparison.lp` for the concrete
...
90. `emdash3_2_walking_interval_restriction.lp` for whole precomposition of
...
91. `emdash3_2_walking_interval_extension.lp` for the whole inverse candidate
...
92. `emdash3_2_walking_interval_universality.lp` for the rule-free
...
93. `emdash3_2_groupoidification_hit.lp` for category-indexed
...
94. `emdash3_2_groupoidification_universality.lp` for whole restriction,
...
95. `emdash3_2_groupoidification_composition.lp` for the nonidentity generic
    unit compositor and one retained next action, both projected from the
    existing ordinary internal-action calculus;
96. `emdash3_2_groupoidification_interval_recovery.lp` for the two extension-
...
97. `emdash3_2_checks.lp` for executable regression statements;
98. `reports/REPORT_EMDASH_V3_2_CURRENT_STATUS_AND_SOP_2026-05-26.md`
    for current architecture and development SOP;
99. `reports/EMDASH_FOUNDATIONS.md` for the mathematical reading;
100. `reports/REPORT_EMDASH_V3_2_CANONICAL_SURFACE_SYNTAX_2026-06-05.md`
    for comment/example notation;
101. `reports/INDEX.md` for task-specific plans and decision records.
102. `book/book.json` and `book/evidence.json` for book source

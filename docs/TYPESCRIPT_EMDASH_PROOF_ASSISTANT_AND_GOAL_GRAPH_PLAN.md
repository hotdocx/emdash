...
| `AGENT-EVAL-12B1` | Representative browser-safe LF patch corpus and canonical interchange | proposal v1 ready for checkpoint/review; no behavior | Executable proposal pins six tracks, ten cases, exact owners/digests, strict canonical APIs, fresh 12A replay, and PathOut/task-kind separation. Eight proposal plus 104 nearest-owner tests, typecheck, focused lint, non-export, and diff hygiene are green; separate review remains mandatory. |

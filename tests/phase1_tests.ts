...
export function runPhase1Tests() {
    ...
    resetMyLambdaPi_Emdash(); // Resets and sets up phase1 + cat primitives
    // setupCatTheoryPrimitives(baseCtx); // Already called by resetMyLambdaPi_Emdash
    // setupPhase1GlobalsAndRules(); // Already called by resetMyLambdaPi_Emdash

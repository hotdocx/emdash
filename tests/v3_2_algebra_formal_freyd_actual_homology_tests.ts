...
import { algebraPolynomialPresentationMorphismAdd } from '../src/v3_2/algebra_polynomial_freyd_category';
...
import { FORMAL_FREYD_ACTUAL_HOMOLOGY_SIGNATURE_BINDINGS, createFormalFreydActualHomologyProofEnvironment } from '../src/v3_2/algebra_formal_freyd_actual_homology_signatures';
import { algebraFormalFreydRetainedHomologyPresentation } from '../src/v3_2/algebra_formal_freyd_model_observation';
...
const construct = async () => {
    ...
    try {
        ...
        return { whole, point, selected, reifier, prepared, providers, reconstruction, initial, source: epicity.source, result, epic,
            aboveLaw, belowLaw: providers.morphismLaw, chainLaw: chainLaw.proof };
...
describe('v3.2 raw connecting preparation', () => {

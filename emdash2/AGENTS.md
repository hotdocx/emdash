...
15. `emdash3_2_commutative_algebra_localization_comparison.lp` for unit
    ...
    interface;
16. `emdash3_2_commutative_algebra_presheaves.lp` for the transparent
...
17. `emdash3_2_sites.lp` for ordinary-sieve membership, the canonical maximal
...
18. `emdash3_2_commutative_algebra_locality.lp` for the coverhood view of the
   ...
   `Spec`, or scheme;
19. `emdash3_2_commutative_algebra_matching.lp` for the Path-valued carrier
...
20. `emdash3_2_commutative_algebra_glue.lp` for selected computational
...
21. `emdash3_2_commutative_algebra_zariski.lp` for selected finite families
...
22. `emdash3_2_commutative_algebra_zariski_topology.lp` for the rule-free
...
23. `emdash3_2_walking_end_hit.lp` for the selected concrete walking-
   endomorphism directed-HIT/`BNat` model, eliminator, comparison, and
   directed negative results;
24. `emdash3_2_checks.lp` for executable regression statements;
25. `reports/REPORT_EMDASH_V3_2_CURRENT_STATUS_AND_SOP_2026-05-26.md`
   for current architecture and development SOP;
26. `reports/EMDASH_FOUNDATIONS.md` for the mathematical reading;
27. `reports/REPORT_EMDASH_V3_2_CANONICAL_SURFACE_SYNTAX_2026-06-05.md`
   for comment/example notation;
28. `reports/INDEX.md` for task-specific plans and decision records.
29. `book/book.json` and `book/evidence.json` for book source

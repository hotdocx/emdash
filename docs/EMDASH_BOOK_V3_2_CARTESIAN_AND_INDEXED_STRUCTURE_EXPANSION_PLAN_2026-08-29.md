...
| `BCIS-LAX-7` | complete audited profile | Chapter 28 already states the final property/evidence architecture. Its only source edit updates the closing transition from five to six spirals; stale primitive-code descriptions were repaired in the appendices. |

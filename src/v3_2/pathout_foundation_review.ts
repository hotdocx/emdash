 ...
 *
 * Proposals v1-v4 and their reviews are retained as superseded evidence.
 * This review approves only checkpointed v5 under the user's standing
...
const rawReview = {
    revision: 'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEWED-4',
    status: 'reviewed-v5-approved-under-delegated-unattended-authority',
    approval: {
        ...
        condition:
            'no-immediate-human-objection-after-v5-proposal-checkpoint',
        ...
        approvedProposalCheckpoint: '622a496'
    },
    recommendation:
    ...
    validation: {
        correctedProposalCheckpoint: '622a496',
    ...
    nonEffects: [
        'does-not-mutate-the-checkpointed-v5-proposal',
...
export function validateCorePathoutFoundation1b0Review(
    ...
    if (
        review.revision !==
            'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEWED-4' ||
        ...
        review.approval.approvedProposalCheckpoint !== '622a496'
    ) {
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_DECISION_DRIFT',
            'The exact corrected-v5 delegated decision drifted'
        );
    }
    ...
    if (
        ...
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_AUTHORIZATION_DRIFT',
            'The review exceeded the exact root-only 4/9/1/9 boundary'
        );
    }
}

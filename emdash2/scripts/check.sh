...
if [[ ${#files[@]} -eq 0 ]]; then
  ...
  files+=(emdash3_2_one_cat_diagram_transpose.lp)
  files+=(emdash3_2_zero_arrow_diagrams.lp)
  files+=(emdash3_2_one_cat_terminal_family_universality.lp)
  files+=(emdash3_2_categorical_contractions.lp)
  files+=(emdash3_2_one_cat_terminal_adjunctions.lp)
  ...
  files+=(emdash3_2_one_cat_adjunction_zero_column_observations.lp)
  ...
  files+=(emdash3_2_one_cat_adjunction_family_views.lp)
  files+=(emdash3_2_zero_arrow_family_action_paths.lp)
  files+=(emdash3_2_one_cat_terminal_family_paths.lp)
  files+=(emdash3_2_one_cat_diagram_family_reflection.lp)
  files+=(emdash3_2_one_cat_arrow_family_isomorphisms.lp)
  files+=(emdash3_2_one_cat_diagram_family_reconstruction.lp)
  files+=(emdash3_2_one_cat_terminal_adjunction_families.lp)
  files+=(emdash3_2_one_cat_terminal_adjunction_family_observations.lp)
  files+=(emdash3_2_one_cat_diagram_family_paths.lp)
  files+=(emdash3_2_one_cat_kernel_cokernel_family_paths.lp)
  files+=(emdash3_2_one_cat_cokernel_family_inputs.lp)
  files+=(emdash3_2_one_cat_cokernel_family_descent.lp)
  files+=(emdash3_2_one_cat_kernel_family_inputs.lp)
  files+=(emdash3_2_one_cat_kernel_family_lift.lp)
  files+=(emdash3_2_one_cat_kernel_precomposition.lp)
  files+=(emdash3_2_hom_action_factorization_views.lp)
  files+=(emdash3_2_one_cat_whiskering_paths.lp)
  files+=(emdash3_2_one_cat_kernel_family_projection_paths.lp)
  files+=(emdash3_2_one_cat_kernel_family_reconstruction.lp)
  files+=(emdash3_2_groupoidal_object_maps.lp)
  files+=(emdash3_2_discrete_functor_paths.lp)
  files+=(emdash3_2_terminal_category_profile.lp)
  files+=(emdash3_2_one_cat_slice_paths.lp)
  files+=(emdash3_2_slice_sigma_arrow_paths.lp)
  files+=(emdash3_2_one_cat_functor_postcomposition_paths.lp)
  files+=(emdash3_2_one_cat_kernel_pullback_comparison.lp)
  files+=(emdash3_2_one_cat_kernel_pullback_lifts.lp)
  files+=(emdash3_2_one_cat_kernel_pullback_universality.lp)
  files+=(emdash3_2_one_cat_cokernel_family_projection_paths.lp)
  files+=(emdash3_2_one_cat_cokernel_family_reconstruction.lp)
  files+=(emdash3_2_omega_equiv_cancellation_paths.lp)
  files+=(emdash3_2_one_cat_short_exact_family_cancellation.lp)
  files+=(emdash3_2_one_cat_homology_cover_maps.lp)
  files+=(emdash3_2_diagram_reindex_views.lp)
  files+=(emdash3_2_one_cat_family_naturality_paths.lp)
  files+=(emdash3_2_one_cat_zero_cone_row_families.lp)
  files+=(emdash3_2_one_cat_kernel_input_observation_paths.lp)
  files+=(emdash3_2_one_cat_zero_family_postcomposition_paths.lp)
  files+=(emdash3_2_one_cat_zero_cone_column_inputs.lp)
  files+=(emdash3_2_one_cat_short_exact_family_lifts.lp)
  files+=(emdash3_2_one_cat_homology_covered_maps.lp)
  files+=(emdash3_2_one_cat_native_homology_window_maps.lp)
  files+=(emdash3_2_one_cat_biproduct_injections.lp)
  files+=(emdash3_2_one_cat_biproduct_adjunction.lp)
  files+=(emdash3_2_one_cat_copair_families.lp)
  files+=(emdash3_2_whiskering_component_paths.lp)
  files+=(emdash3_2_one_cat_copair_family_paths.lp)
  files+=(emdash3_2_one_cat_additive_families.lp)
  files+=(emdash3_2_one_cat_additive_family_paths.lp)
  files+=(emdash3_2_additive_shears.lp)
  files+=(emdash3_2_one_cat_product_family_inverse_components.lp)
  files+=(emdash3_2_one_cat_shear_families.lp)
  files+=(emdash3_2_preadditive_zero_family_components.lp)
  files+=(emdash3_2_one_cat_negative_identity.lp)
  files+=(emdash3_2_one_cat_negative_families.lp)
  files+=(emdash3_2_one_cat_difference_families.lp)
  files+=(emdash3_2_product_composition_paths.lp)
  files+=(emdash3_2_product_family_action_views.lp)
  files+=(emdash3_2_one_cat_adjunction_transpose_paths.lp)
  files+=(emdash3_2_product_family_tuple_paths.lp)
  files+=(emdash3_2_one_cat_product_family_projection_paths.lp)
  files+=(emdash3_2_product_family_maps.lp)
  files+=(emdash3_2_one_cat_biproduct_family_distribution.lp)
  files+=(emdash3_2_one_cat_additive_family_bilinearity.lp)
  files+=(emdash3_2_one_cat_difference_family_bilinearity.lp)
  files+=(emdash3_2_reindex_composition_paths.lp)
  files+=(emdash3_2_one_cat_adjunction_family_reindex.lp)
  files+=(emdash3_2_product_family_reindex.lp)
  files+=(emdash3_2_one_cat_biproduct_family_reindex.lp)
  files+=(emdash3_2_one_cat_shear_additive_inverse_paths.lp)
  files+=(emdash3_2_one_cat_additive_family_inverse.lp)
  files+=(emdash3_2_one_cat_additive_family_cancellation.lp)
  files+=(emdash3_2_omega_equiv_composition.lp)
  files+=(emdash3_2_one_cat_zero_kernel_families.lp)
  files+=(emdash3_2_one_cat_coimage_factor_paths.lp)
  files+=(emdash3_2_one_cat_difference_cospans.lp)
  files+=(emdash3_2_one_cat_cokernel_family_annihilation.lp)
  files+=(emdash3_2_one_cat_zero_cokernel_covers.lp)
  files+=(emdash3_2_one_cat_difference_cokernels.lp)
  files+=(emdash3_2_one_cat_difference_covers.lp)
  files+=(emdash3_2_one_cat_coimage_cover_descent.lp)
  files+=(emdash3_2_one_cat_difference_cover_closure.lp)
  files+=(emdash3_2_one_cat_kernel_difference_lifts.lp)
  files+=(emdash3_2_one_cat_difference_factor_paths.lp)
  files+=(emdash3_2_one_cat_kernel_precomposition_covers.lp)
  files+=(emdash3_2_one_cat_homology_covers.lp)
  files+=(emdash3_2_one_cat_native_homology_window_covers.lp)
  files+=(emdash3_2_one_cat_kernel_input_boundaries.lp)
  files+=(emdash3_2_one_cat_native_connecting_kernel_paths.lp)
  files+=(emdash3_2_one_cat_native_cycles_connecting.lp)
  files+=(emdash3_2_one_cat_native_connecting_upper_lifts.lp)
  files+=(emdash3_2_one_cat_native_connecting.lp)
  files+=(emdash3_2_one_cat_native_homology_window_connecting.lp)
  files+=(emdash3_2_functor_category_unit_views.lp)
  files+=(emdash3_2_one_cat_arrow_family_maps.lp)
  files+=(emdash3_2_one_cat_kernel_cokernel_family_maps.lp)
  files+=(emdash3_2_one_cat_homology_family_maps.lp)
  files+=(emdash3_2_one_cat_middle_column_inputs.lp)
  files+=(emdash3_2_one_cat_row_homology_maps.lp)
  files+=(emdash3_2_one_cat_row_homology_zero_pairs.lp)
  files+=(emdash3_2_one_cat_covered_middle_cycles.lp)
  files+=(emdash3_2_one_cat_native_connecting_projection_zero.lp)
  files+=(emdash3_2_one_cat_native_connecting_inclusion_zero.lp)
  files+=(emdash3_2_one_cat_native_homology_window_exact_inputs.lp)
  files+=(emdash3_2_one_cat_zero_cokernel_families.lp)
  files+=(emdash3_2_one_cat_inverse_from_universal_zeros.lp)
  files+=(emdash3_2_one_cat_image_kernel_inclusion_paths.lp)
  files+=(emdash3_2_one_cat_image_kernel_exactness.lp)
  files+=(emdash3_2_one_cat_native_exact_comparison_kernels.lp)
  files+=(emdash3_2_one_cat_cospan_kernel_covers.lp)
  files+=(emdash3_2_one_cat_quotient_cokernel_zero.lp)
  files+=(emdash3_2_one_cat_homology_representatives.lp)
  files+=(emdash3_2_one_cat_boundary_representatives.lp)
  files+=(emdash3_2_one_cat_middle_homology_representatives.lp)
  files+=(emdash3_2_one_cat_middle_homology_cycles.lp)
  files+=(emdash3_2_one_cat_biproduct_injection_reindex.lp)
  files+=(emdash3_2_one_cat_copair_injection_paths.lp)
  files+=(emdash3_2_one_cat_additive_family_units.lp)
  files+=(emdash3_2_one_cat_middle_homology_exactness.lp)
  files+=(emdash3_2_one_cat_native_middle_homology_exactness.lp)
  files+=(emdash3_2_one_cat_connecting_source_representatives.lp)
  files+=(emdash3_2_one_cat_connecting_source_cycles.lp)
  files+=(emdash3_2_one_cat_connecting_source_exactness.lp)
  files+=(emdash3_2_one_cat_connecting_target_representatives.lp)
  files+=(emdash3_2_one_cat_connecting_target_lifts.lp)
  files+=(emdash3_2_one_cat_connecting_target_exactness.lp)
  files+=(emdash3_2_one_cat_image_coimage_comparison.lp)
  files+=(emdash3_2_one_cat_adjunction_normality.lp)
  files+=(emdash3_2_one_cat_abelian_adjunctions.lp)
  files+=(emdash3_2_zero_arrow_family_observations.lp)
  files+=(emdash3_2_one_cat_zero_family_paths.lp)
  ...
  files+=(emdash3_2_kernel_cokernel_adjunction_observations.lp)
  files+=(emdash3_2_kernel_adjunction_mates.lp)
  files+=(emdash3_2_cokernel_adjunction_mates.lp)
  files+=(emdash3_2_homology_adjunction_families.lp)
  files+=(emdash3_2_cokernel_adjunction_families.lp)
  ...
  files+=(emdash3_2_zero_arrow_cone_adjunction_homology.lp)
  ...
  files+=(emdash3_2_chain_pair_diagrams.lp)
  ...
  files+=(emdash3_2_homology_adjunction_record_data.lp)
  files+=(emdash3_2_homology_family_records.lp)
  files+=(emdash3_2_chain_pair_homology_records.lp)
  files+=(emdash3_2_commutative_algebra_freyd_chain_pair_data.lp)
  files+=(emdash3_2_commutative_algebra_freyd_zero_cone_inputs.lp)
  files+=(emdash3_2_one_cat_arrow_diagrams.lp)
  files+=(emdash3_2_walking_arrow_native_observation.lp)
  files+=(emdash3_2_functor_reconstruction_paths.lp)
  files+=(emdash3_2_one_cat_diagram_reconstruction.lp)
  files+=(emdash3_2_one_cat_zero_arrow_inputs.lp)
  files+=(emdash3_2_one_cat_chain_pair_inputs.lp)
  files+=(emdash3_2_one_cat_zero_diagram_inputs.lp)
  files+=(emdash3_2_one_cat_native_square_paths.lp)
  files+=(emdash3_2_one_cat_diagram_map_paths.lp)
  files+=(emdash3_2_one_cat_adjunction_cancellation.lp)
  files+=(emdash3_2_one_cat_adjunction_records.lp)
  files+=(emdash3_2_one_cat_adjunction_selected_views.lp)
  files+=(emdash3_2_one_cat_homology_adjunction_records.lp)
  files+=(emdash3_2_one_cat_chain_pair_homology_records.lp)
  ...
  files+=(emdash3_2_commutative_algebra_freyd_chain_map_data.lp)
  files+=(emdash3_2_commutative_algebra_freyd_native_maps.lp)
  files+=(emdash3_2_commutative_algebra_freyd_adjunction_homology_maps.lp)
  ...
  files+=(emdash3_2_preadditive_zero_identity.lp)
  files+=(emdash3_2_homology_record_zero.lp)
  files+=(emdash3_2_homology_whole_zero.lp)
  ...
  files+=(emdash3_2_one_cat_adjunction_introduction.lp)

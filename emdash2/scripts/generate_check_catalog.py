...
AREAS: list[Area] = [
    ...
    Area(
        ...
        (
            ...
            "omega_equiv_along_left_law",
            "omega_equiv_along_right_law",
            "omega_equiv_along_ind",
            "omega_equiv_along_refl",
            "OmegaEquiv",
            "omega_equiv_pack",
            "omega_equiv_to",
            ...
            "omega_equiv_eta",
            "OmegaEquivSigma",
            "omega_facade_to_sigma",
            "omega_sigma_to_facade",
            "omega_sigma_roundtrip",
            "omega_facade_roundtrip",
            "object_path_equiv_",
            "@object_path_equiv",
            "path_equiv_",
            "@path_equiv",
            "IsGroupoidalCat",
            "path_cat_is_groupoidal",
        ),
    ),
    Area(

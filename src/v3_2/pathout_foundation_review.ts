 ...
 *
 * Proposals v1-v8 and their reviews are retained as superseded evidence.
 * This review approves only checkpointed v9 under the user's standing
...
const rawReview = {
    revision: 'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEWED-8',
    status: 'reviewed-v9-approved-under-delegated-unattended-authority',
    approval: {
        ...
        condition:
            'no-immediate-human-objection-after-v9-proposal-checkpoint',
        ...
        approvedProposalCheckpoint: 'b4277fb'
    },
    recommendation:
    ...
    validation: {
        correctedProposalCheckpoint: 'b4277fb',
    ...
    nonEffects: [
        'does-not-mutate-the-checkpointed-v9-proposal',
...
export function validateCorePathoutFoundation1b0Review(
    ...
    if (
        ...
        review.approval.approvedProposalCheckpoint !== 'b4277fb'
    ) {
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_DECISION_DRIFT',
            'The exact corrected-v9 delegated decision drifted'
        );
    }
    ...
    if (
        ...
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_PROPOSAL_DRIFT',
            'The review must retain exact non-authorizing proposal v9'
        );
    }
    ...
    if (
        ...
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_AUTHORIZATION_DRIFT',
            'The review exceeded the exact root-only 5/13/2/9 boundary'
        );
    }
}

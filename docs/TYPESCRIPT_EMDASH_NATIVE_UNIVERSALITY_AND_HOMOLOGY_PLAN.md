...
Status: active — left H and right quotient/γ-diagram comparisons qualified; right kernel/H and sign next; six-term observation gap and displayed CAS transport still required
...
| NUH-6 | active: left H and right quotient/γ-diagram comparisons qualified; right kernel/H and sign next; 6C3b gap retained | Complete LES/reference/sign work and the retained comparison/witness qualification before NUH-7 |

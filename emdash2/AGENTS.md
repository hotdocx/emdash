...
86. `emdash3_2_face_realization.lp` for variable-dimension realization of
...
107. `emdash3_2_dependent_simplex_represented_source.lp` for the rule-free
...
108. `emdash3_2_dependent_simplex_native_dimensions.lp` for the rule-free
...
110. `emdash3_2_dependent_simplex_codes.lp` for the curated intrinsically
...
112. `emdash3_2_dependent_simplex_faces.lp` for whole nonempty-face action on

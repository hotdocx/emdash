...
| `LEH-SNAKE-KERNEL-MAPS-3A` | complete; checkpoint pending | snake spine and selected kernels | `Ker(alpha) -> Ker(beta) -> Ker(gamma)` as selected kernel lifts with both reconstruction paths |

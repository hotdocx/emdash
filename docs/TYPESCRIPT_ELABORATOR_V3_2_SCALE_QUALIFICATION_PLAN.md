...
`f53fd68f91a4e7f9e401b851eaf03665d5509b87`. None changes or resumes a scale
...
- **2026-07-29 — Product browser/syntax audits split into dedicated
  plans.** ORACLE-0A retains the existing optional authority commands.
  BROWSER-0A proves the directed-dependent closure Node-free,
  Vite-production-green, and Chromium-green, while locating the categorical
  bundle failure in acquisition/digest layering rather than kernel
  mathematics. SYNTAX-0A specifies a parser-independent located syntax and

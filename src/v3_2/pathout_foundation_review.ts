 ...
 * PATHOUT-LIBRARY-FOUNDATION-1B0 proposal v8.
 *
 * Measured reflexive action requires the adjacent active identity-incoming
 * precomposition rule. The v8 authorization is withdrawn while proposal v9
...
const rawReview = {
    revision: 'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEW-SUPERSEDED-8',
    status: 'proposal-v8-review-superseded-v9-awaiting-separate-review',
    approval: {
        ...
        condition:
            'reflexive-consumer-reaches-stable-precomposition-of-' +
            'identity-incoming-arrow-versus-the-original-arrow',
    ...
    validation: {
        ...
        supersededV8ReviewCheckpoint: 'edda832',
        measuredFailure:
            'general-source-action-passes-but-reflexive-consumer-stops-' +
            'at-hom_precomp_along_fapp0-of-p-and-id-versus-p',
    ...
    gitBoundary: {
        rollbackEvidence:
            'v1-v8-proposals-and-reviews-preserved-as-superseded',
    ...
    nonEffects: [
        'preserves-v8-proposal-and-review-as-Git-backtracking-evidence',
        'does-not-approve-superseded-v1-v2-v3-v4-v5-v6-v7-or-v8',
        'does-not-revive-any-superseded-review',
        'does-not-approve-replacement-v9',
    ...
    nextDependencyState:
        'pathout-foundation-1b0-v9-awaiting-separate-review'
} as const;
...
export function validateCorePathoutFoundation1b0Review(
    ...
    if (
        review.revision !==
            'PATHOUT-LIBRARY-FOUNDATION-1B0-REVIEW-SUPERSEDED-8' ||
        ...
        review.approval.supersededV8ProposalCheckpoint !== '6e4bb82' ||
        review.approval.supersededV8ReviewCheckpoint !== 'edda832' ||
        review.approval.replacementProposalCheckpoint !==
            'pending-separate-checkpoint'
    ) {
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_DECISION_DRIFT',
            'The exact corrected-v8 supersession decision drifted'
        );
    }
    ...
    if (
        ...
        throw new CorePathoutFoundation1b0ReviewError(
            'PATHOUT_FOUNDATION_REVIEW_PROPOSAL_DRIFT',
            'The supersession must retain exact non-authorizing proposal v9'
        );
    }
